...
public class JavaSwing22_23 extends JFrame{
	...
	public JavaSwing22_23(){
		...
		subtractNums = new JRadioButton("Substract");
		...
		public void actionPerformed(ActionEvent e){
			if(e.getSource() == button1){
				try{
					...
					JOptionPane.showMessageDialog(JavaSwing22_23.this, "Please Enter the Right Info", "Error", JOptionPane.ERROR_MESSAGE);
					System.exit(0);
				}
				...
				if(dollarSign.isSelected()){
					...
					JOptionPane.showMessageDialog(JavaSwing22_23.this, numFormat.format(totalCalc),"Solution", JOptionPane.INFORMATION_MESSAGE);
					
				} else if(commaSeparator.isSelected()){
					NumberFormat  numFormat = NumberFormat.getNumberInstance();
					JOptionPane.showMessageDialog(JavaSwing22_23.this, numFormat.format(totalCalc),"Solution", JOptionPane.INFORMATION_MESSAGE);
				} else {
					JOptionPane.showMessageDialog(JavaSwing22_23.this,totalCalc, "Solution", JOptionPane.INFORMATION_MESSAGE);
				}
